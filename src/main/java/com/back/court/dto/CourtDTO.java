...
public class CourtDTO {
	...
	public String getFirst_img_name() {
		return first_img_name;
	}
	public void setFirst_img_name(String first_img_name) {
		this.first_img_name = first_img_name;
	}
	public int getJjim() {
		return jjim;
	}
